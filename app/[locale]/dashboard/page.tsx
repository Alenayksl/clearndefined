      ...
      <div
        ...
        <div className="flex flex-col items-center justify-center mt-10">
          ...
          <div style={{ position: "absolute", bottom: "2rem" }}>
            <button
              className="w-full py-2 bg-cyan-800 hover:bg-cyan-950 text-white px-4 rounded-2xl shadow-md transition-all duration-200 font-extralight"
