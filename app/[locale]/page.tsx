      ...
      <main className="flex flex-col items-center justify-center min-h-screen">
        <div className="absolute top-0 left-5">
          <a href="#" className="-m-1.5 p-1.5">
            ...
            <Image src={"/images/books.png"} alt="" width={30} height={30} />
          </a>
        </div>

        <div className="absolute top-4 right-4 flex gap-2">
          <div className="flex gap-2">
            <MyButton onClick={() => router.push(`/${currentLocale}/login`)}>
              {t("button")}
            </MyButton>
            <MyButton onClick={() => router.push(`/${currentLocale}/register`)}>
        ...
        <h1 className="text-5xl flex-col items-center justify-center mt-10 text-cyan-800 font-semibold">
          {currentLocale === "tr" ? "KÜTÜPHANE" : "LIBRARY"}
        </h1>
        <p className="flex-col items-center justify-center max-w-120 text-cyan-800 ">
          {" "}
          {currentLocale === "tr"
            ? "Kütüphane uygulamasına hoşgeldin, çalışma odası tutabilir ya da var olan odalarını görebilirsin."
            : "Welcome to the Library app, you can book a study room or check out the rooms you already have."}
        </p>
